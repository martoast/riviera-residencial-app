...
<head>
    ...
    <title><?php echo e($title ?? 'Candé by FRISA · Real del Mar — Casas y departamentos frente al Pacífico'); ?></title>
    <meta name="description" content="<?php echo e($description ?? 'Candé by FRISA es una etapa residencial de lujo dentro de Real del Mar: 37 casas y 54 departamentos con vistas al mar, campo de golf y un estilo de vida tipo resort en Baja California.'); ?>">
    ...
    <meta property="og:image" content="<?php echo e($siteUrl); ?>/images/og-cande.jpg">
    ...
    <meta name="twitter:image" content="<?php echo e($siteUrl); ?>/images/og-cande.jpg">
...
>
    ...
    <div id="preloader" class="fixed inset-0 z-[100] flex items-center justify-center bg-ocean-950">
        <div class="preloader-mark flex flex-col items-center">
            <?php echo $__env->make('partials.logo', ['class' => 'h-14 w-auto text-sand-50'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    >
        <nav class="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-10">
            ...
            >
                <?php echo $__env->make('partials.logo', ['class' => 'h-12 w-auto lg:h-14'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <span
        ...
        <div class="mx-auto max-w-7xl px-6 py-16 lg:px-10">
            <div class="grid gap-12 md:grid-cols-3">
                <div class="text-sand-50">
                    <?php echo $__env->make('partials.logo', ['class' => 'h-10 w-auto'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $component->withAttributes([]); ?>
                             <?php $__env->slot('es', null, []); ?> Un desarrollo integral frente al Pacífico. Respaldado por Grupo FRISA, diseñado por Cuaik. <?php $__env->endSlot(); ?>
                             <?php $__env->slot('en', null, []); ?> An integrated development facing the Pacific. Backed by Grupo FRISA, designed by Cuaik. <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                         <?php $__env->slot('es', null, []); ?> © <?php echo e(date('Y')); ?> Real del Mar. Todos los derechos reservados. · Aviso de Privacidad <?php $__env->endSlot(); ?>
                         <?php $__env->slot('en', null, []); ?> © <?php echo e(date('Y')); ?> Real del Mar. All rights reserved. · Privacy Notice <?php $__env->endSlot(); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal618076cb2e02e8026719e8ebca35f227)): ?>
<?php $attributes = $__attributesOriginal618076cb2e02e8026719e8ebca35f227; ?>
...
<?php endif; ?>
    ...
    <a
        :href="$store.lang.current === 'en'
            ? 'https://wa.me/526641158106?text=Hi%2C%20I%27m%20interested%20in%20Real%20del%20Mar.%20Could%20you%20send%20me%20more%20information%3F'
            : 'https://wa.me/526641158106?text=Hola%2C%20me%20interesa%20Real%20del%20Mar%2C%20%C2%BFme%20pueden%20enviar%20informaci%C3%B3n%3F'"
        href="https://wa.me/526641158106?text=Hola%2C%20me%20interesa%20Real%20del%20Mar%2C%20%C2%BFme%20pueden%20enviar%20informaci%C3%B3n%3F"
...
<?php /**PATH /Users/alex/Documents/ricardo/riviera-residencial/app/resources/views/layouts/app.blade.php ENDPATH**/ ?>