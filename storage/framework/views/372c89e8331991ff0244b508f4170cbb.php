...
<head>
    ...
    <title><?php echo e($title ?? 'Riviera Residencial · Real del Mar — Casas con vista al mar y golf en Tijuana–Rosarito'); ?></title>
    <meta name="description" content="<?php echo e($description ?? 'Riviera Residencial Etapa II: 46 casas dentro de Real del Mar, modelos Murano y Mazzorbo, con casa club, alberca, golf y vistas al mar. Un desarrollo de HIR Baja, comercializado por BCapital Brokers.'); ?>">
    ...
    <meta property="og:image" content="<?php echo e($siteUrl); ?>/images/riviera-hero.jpg">
    ...
    <meta name="twitter:image" content="<?php echo e($siteUrl); ?>/images/riviera-hero.jpg">
...
>
    ...
    <div id="preloader" class="fixed inset-0 z-[100] flex items-center justify-center bg-ocean-950">
        <div class="preloader-mark flex flex-col items-center text-sand-50">
            <?php echo $__env->make('partials.logo', ['class' => 'h-14 w-auto'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    >
        <nav class="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-10">
            ...
            >
                <?php echo $__env->make('partials.logo', ['class' => 'h-11 w-auto lg:h-12'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </a>
            ...
            <div class="space-y-1 border-t border-ink/5 bg-sand-50 px-6 pb-8 pt-4">
                <?php $__currentLoopData = $navLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($item['href']); ?>" @click="navOpen = false"
                        class="display block py-3 text-2xl text-ink transition-colors hover:text-gold-500"><?php echo e($item['label']); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mx-auto max-w-7xl px-6 py-16 lg:px-10">
            <div class="grid gap-12 md:grid-cols-3">
                ...
                <div class="text-sand-50">
                    <?php echo $__env->make('partials.logo', ['class' => 'h-12 w-auto'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="mt-14 border-t border-sand-50/10 pt-8 text-xs leading-relaxed text-sand-200/50">
                <p>© <?php echo e(date('Y')); ?> Riviera Residencial · Real del Mar. Todos los derechos reservados. · Aviso de Privacidad</p>
                <p class="mt-2">
    ...
    <div class="fixed bottom-6 right-6 z-40 flex flex-col items-center gap-3">
        ...
        <a href="<?php echo e($mapsUrl); ?>" target="_blank" rel="noopener" aria-label="Ver ubicación en Google Maps"
        ...
        <a href="tel:<?php echo e($telNumber); ?>" aria-label="Llamar"
        ...
        <a href="https://wa.me/<?php echo e($waNumber); ?>?text=<?php echo e($waText); ?>" target="_blank" rel="noopener" aria-label="WhatsApp"
