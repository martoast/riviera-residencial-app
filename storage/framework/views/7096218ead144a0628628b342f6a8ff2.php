...
<section id="casa-club" class="grain relative flex min-h-[80svh] items-end overflow-hidden bg-ocean-950">
    <div class="absolute inset-0">
        <img src="<?php echo e(asset('images/riviera-alberca.jpg')); ?>" alt="Casa Club con alberca en Riviera Residencial" loading="lazy"
    ...
    <div class="relative mx-auto w-full max-w-7xl px-6 pb-20 lg:px-10">
        <div class="reveal-group max-w-xl">
            <p class="eyebrow text-gold-300">Casa Club</p>
            <h2 class="display mt-5 text-4xl font-light text-sand-50 drop-shadow-[0_2px_24px_rgba(10,26,38,0.6)] sm:text-5xl">Conoce nuestra <span class="accent-italic">Casa Club</span></h2>
...
<?php /**PATH /Users/alex/Documents/ricardo/riviera-residencial/app/resources/views/partials/casa-club.blade.php ENDPATH**/ ?>