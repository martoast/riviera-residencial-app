    ...
    <div class="mx-auto max-w-5xl px-6 text-center lg:px-10">
        ...
        <div class="reveal mt-12 grid gap-6 sm:grid-cols-2">
            <?php $__currentLoopData = $planos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button type="button"
                    @click="open = true; src = '<?php echo e(asset('images/' . $p['img'])); ?>'; title = 'Plano <?php echo e($p['n']); ?>'"
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('images/' . $p['img'])); ?>" alt="Plano del modelo <?php echo e($p['n']); ?>" loading="lazy"
                    ...
                    <p class="eyebrow py-4 text-[0.65rem] text-ink">Ver plano <?php echo e($p['n']); ?></p>
                </button>
...
<?php /**PATH /Users/alex/Documents/ricardo/riviera-residencial/app/resources/views/partials/planos.blade.php ENDPATH**/ ?>