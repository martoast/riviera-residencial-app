        ...
        <?php $__currentLoopData = $zona; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $z): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <article data-card class="group w-[70vw] shrink-0 snap-start sm:w-[320px] lg:w-[360px]">
                <div class="relative overflow-hidden rounded-2xl bg-ocean-950 shadow-lg shadow-ink/5">
                    <img src="<?php echo e(asset('images/' . $z['img'])); ?>" alt="<?php echo e($z['t']); ?> en Real del Mar" loading="lazy"
                    ...
                    <h3 class="display absolute inset-x-0 bottom-0 p-6 text-2xl text-sand-50"><?php echo e($z['t']); ?></h3>
                </div>
            </article>
...
<?php /**PATH /Users/alex/Documents/ricardo/riviera-residencial/app/resources/views/partials/zona.blade.php ENDPATH**/ ?>