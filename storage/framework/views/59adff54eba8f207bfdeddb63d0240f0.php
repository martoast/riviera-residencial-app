...
<?php
    $amenidades = [
        ...
        ['img' => 'rdm-am-club.jpg',         't_es' => 'Casa Club',          't_en' => 'Clubhouse',        'd_es' => 'Espacios sociales elegantes para convivir y relajarse.', 'd_en' => 'Elegant social spaces to gather and relax.'],
        ['img' => 'rdm-am-hotel.jpg',        't_es' => 'Hotel',             't_en' => 'Hotel',            'd_es' => 'Hospedaje y descanso de resort, con todos los servicios a tu alcance.', 'd_en' => 'Resort lodging and relaxation, with every service within reach.'],
        ...
        ['img' => 'rdm-am-restaurante-pizza.jpg', 't_es' => 'Restaurante y bar', 't_en' => 'Restaurant & bar','d_es' => 'Buena comida y un lugar para reunirte, a unos pasos de casa.', 'd_en' => 'Good food and a place to gather, just steps from home.'],
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                         <?php $__env->slot('es', null, []); ?> Vivir en Candé significa tener acceso a las amenidades exclusivas de Real del Mar — un entorno diseñado para disfrutar, relajarse y mantenerse activo, siempre con el mar como telón de fondo. <?php $__env->endSlot(); ?>
                         <?php $__env->slot('en', null, []); ?> Living in Candé means access to the exclusive amenities of Real del Mar — an environment designed to enjoy, relax, and stay active, always with the sea as a backdrop. <?php $__env->endSlot(); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal618076cb2e02e8026719e8ebca35f227)): ?>
<?php $attributes = $__attributesOriginal618076cb2e02e8026719e8ebca35f227; ?>
...
<?php /**PATH /Users/alex/Documents/ricardo/riviera-residencial/app/resources/views/partials/amenidades.blade.php ENDPATH**/ ?>