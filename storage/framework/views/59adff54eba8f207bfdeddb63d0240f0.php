            ...
            <?php $__currentLoopData = $amenidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex flex-col items-center rounded-2xl bg-white p-7 text-center shadow-sm shadow-ink/5 ring-1 ring-ink/5">
                    <span class="flex h-14 w-14 items-center justify-center rounded-full bg-olive-500/10 text-olive-700">
                        <svg class="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="<?php echo e($a['i']); ?>"/></svg>
                    </span>
                    <p class="mt-4 text-sm font-medium text-ink"><?php echo e($a['t']); ?></p>
                </div>
