...
<section id="exteriores" class="bg-sand-50 py-24 lg:py-32"
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div class="reveal mt-12 grid auto-rows-[220px] grid-cols-2 gap-4 lg:grid-cols-4">
            <?php $__currentLoopData = $exteriores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button type="button" @click="open = true; src = '<?php echo e(asset('images/' . $e['img'])); ?>'; title = '<?php echo e($e['t']); ?>'"
                    class="group relative overflow-hidden rounded-2xl bg-ocean-950 <?php echo e($e['span']); ?>">
                    <img src="<?php echo e(asset('images/' . $e['img'])); ?>" alt="<?php echo e($e['t']); ?> — Riviera Residencial" loading="lazy"
                    ...
                    <span class="eyebrow absolute bottom-4 left-4 text-[0.6rem] text-sand-50 opacity-0 transition-opacity group-hover:opacity-100"><?php echo e($e['t']); ?></span>
                </button>
...
<?php /**PATH /Users/alex/Documents/ricardo/riviera-residencial/app/resources/views/partials/exteriores.blade.php ENDPATH**/ ?>