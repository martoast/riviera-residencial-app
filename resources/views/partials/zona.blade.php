...
@php
    $amenities = [
        ...
        [
            ...
            'imgs' => ['rdm-hotel-1', 'rdm-hotel-2', 'rdm-hotel-3', 'rdm-hotel-4', 'rdm-hotel-5'],
        ],
        [
            't' => 'Pádel y tenis',
            'sub' => 'Deporte y recreación',
            ...
            'imgs' => ['rdm-padel-1', 'rdm-padel-2', 'rdm-padel-3', 'rdm-padel-4'],
        ],
        [
            't' => 'Club hípico',
            'sub' => 'Deporte y recreación',
            ...
            'imgs' => ['rdm-hipico-1', 'rdm-hipico-2'],
        ],
        [
            ...
            'imgs' => ['rdm-natura-1', 'rdm-natura-2'],
        ],
        [
            't' => 'Capilla',
            'sub' => 'Comunidad',
