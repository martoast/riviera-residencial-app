...
>
    ...
    <footer class="bg-ocean-950 text-sand-200">
        <div class="mx-auto max-w-7xl px-6 py-16 lg:px-10">
            ...
            <div class="mt-14 border-t border-sand-50/10 pt-8 text-xs leading-relaxed text-sand-200/50">
                <p>© {{ date('Y') }} Riviera Residencial · Real del Mar. Todos los derechos reservados. · Aviso de Privacidad</p>
                <p class="mt-2">
    ...
    <div class="fixed bottom-6 right-6 z-40 flex flex-col items-center gap-3">
        ...
        {{-- WhatsApp --}}
        <a href="https://wa.me/{{ $waNumber }}?text={{ $waText }}" target="_blank" rel="noopener" aria-label="WhatsApp"
